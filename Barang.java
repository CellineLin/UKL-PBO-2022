...
public class Barang extends Lelang {
    ...
    public int jmlBarang = namaBarang.size();

    public Barang() {
        this.namaBarang.add("Lukisan Claude Monet");
        this.hargaAwal.add(15000);
        this.status.add(true);

        this.namaBarang.add("Keramik China");
        this.hargaAwal.add(35000);
        this.status.add(true);
